...
2. Download and run the following bash script to convert the FASTQ files to FASTA files. Note, SampleC part2 will be automatically excluded by running the script: [fastq_to_fasta.sh](https://github.com/transitorybiorepository/analysis_pipeline/blob/main/fastq_to_fasta.sh)
